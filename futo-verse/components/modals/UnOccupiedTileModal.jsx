  ...
  return (
    <>
      ...
      <Modal
        ...
        height="fit"
      >
        <div className="flex flex-col gap-3 mb-2 text-light-1">
        ...
        <div className="flex flex-col gap-4 items-center justify-center">
          <div className="flex gap-3 w-full">
            {numberOfShops >= 1 && (
              <button
                className="bg-primary-500 text-white p-1 rounded-lg px-4 w-1/2"
      ...
      <Modal
        ...
        height="fit"
      >
        <h6 className="text-xl font-semibold">Pitch Your Business</h6>
        <h6 className="text-slate-500 text-sm">occupied</h6>
      ...
      >
        <div className=""></div>
        <h6 className="text-lg font-semibold">Confirm Your Pitch</h6>
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <div className="flex gap-2 text-sm">
            <button
              className="bg-gray-500 text-white p-1 rounded-lg px-4"
              onClick={() => {
